...
type LoginRequest struct {
	...
	SplitTunnel       []string `protobuf:"bytes,44,rep,name=split_tunnel,json=splitTunnel,proto3" json:"split_tunnel,omitempty"`
	// cleanSplitTunnel clears the split tunnel list.
	// Needed because generated code omits empty slices due to omitempty tags.
	CleanSplitTunnel bool `protobuf:"varint,45,opt,name=cleanSplitTunnel,proto3" json:"cleanSplitTunnel,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type GetConfigResponse struct {
	...
	SplitTunnel []string `protobuf:"bytes,30,rep,name=splitTunnel,proto3" json:"splitTunnel,omitempty"`
	// dnsLabels settings value.
	DnsLabels []string `protobuf:"bytes,31,rep,name=dnsLabels,proto3" json:"dnsLabels,omitempty"`
	// natExternalIPs map list of external IPs.
	NatExternalIPs []string `protobuf:"bytes,32,rep,name=natExternalIPs,proto3" json:"natExternalIPs,omitempty"`
	...
	IfaceBlacklist   []string             `protobuf:"bytes,33,rep,name=ifaceBlacklist,proto3" json:"ifaceBlacklist,omitempty"`
	CustomDNSAddress []byte               `protobuf:"bytes,34,opt,name=customDNSAddress,proto3" json:"customDNSAddress,omitempty"`
	DnsRouteInterval *durationpb.Duration `protobuf:"bytes,35,opt,name=dnsRouteInterval,proto3" json:"dnsRouteInterval,omitempty"`
	DisableFirewall  bool                 `protobuf:"varint,36,opt,name=disableFirewall,proto3" json:"disableFirewall,omitempty"`
	// fullConfigSnapshot is set to true by a daemon that populates ALL
	// configuration fields in this response (including 30-36). An older
	...
	FullConfigSnapshot bool `protobuf:"varint,37,opt,name=fullConfigSnapshot,proto3" json:"fullConfigSnapshot,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type SetConfigRequest struct {
	...
	SplitTunnel       []string `protobuf:"bytes,39,rep,name=split_tunnel,json=splitTunnel,proto3" json:"split_tunnel,omitempty"`
	// cleanSplitTunnel clears the split tunnel list.
	// Needed because generated code omits empty slices due to omitempty tags.
	CleanSplitTunnel bool `protobuf:"varint,40,opt,name=cleanSplitTunnel,proto3" json:"cleanSplitTunnel,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
const file_daemon_proto_rawDesc = "" +
	...
	"\busername\x18\x02 \x01(\tR\busername\"\xb5\f\n" +
	...
	"\vsplitTunnel\x18\x1e \x03(\tR\vsplitTunnel\x12\x1c\n" +
	"\tdnsLabels\x18\x1f \x03(\tR\tdnsLabels\x12&\n" +
	"\x0enatExternalIPs\x18  \x03(\tR\x0enatExternalIPs\x12&\n" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id\"\xd3\x13\n" +
